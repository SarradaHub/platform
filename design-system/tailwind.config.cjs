...
// Since the package uses "type": "module", the compiled files are ES modules
// We need to use createRequire with __filename to load them in CommonJS context
const { createRequire } = require('module');
const path = require('path');
const requireESM = createRequire(__filename);

const colorsModule = requireESM('./dist/foundations/colors.js');
const typographyModule = requireESM('./dist/foundations/typography.js');
const spacingModule = requireESM('./dist/foundations/spacing.js');
const shadowsModule = requireESM('./dist/foundations/shadows.js');
const borderRadiusModule = requireESM('./dist/foundations/borderRadius.js');
const breakpointsModule = requireESM('./dist/foundations/breakpoints.js');
